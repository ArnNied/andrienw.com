...
export default function HomePage() {
  const contacts = [
    {
      name: 'Email',
      label: 'arnnied03@gmail.com',
      link: 'mailto:arnnied03@gmail.com',
      fill: '#EA4335',
      icon: (
        <svg
          role='img'
          ...
          className='fill-secondary group-hover:fill-[#EA4335] transition-colors duration-150'
        >
          <title>Gmail</title>
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox='0 0 24 24'
          xmlns='http://www.w3.org/2000/svg'
          className='fill-secondary group-hover:fill-[#E8EAEA] transition-colors duration-150'
        >
          <title>GitHub</title>
    ...
    },
    {
      ...
      link: 'https://www.linkedin.com/in/andrien-wiandyano/',
      fill: '#0A66C2',
      icon: (
        <svg
          role='img'
          viewBox='0 0 24 24'
          xmlns='http://www.w3.org/2000/svg'
          className='fill-secondary group-hover:fill-[#0A66C2] transition-colors duration-150'
        >
    ...
    },
    {
      name: 'Discord',
      label: 'arnnied',
      link: 'https://discord.com/users/293697497535217664',
      fill: '#7289DA',
      icon: (
        <svg
          role='img'
          viewBox='0 0 24 24'
          xmlns='http://www.w3.org/2000/svg'
          className='fill-secondary group-hover:fill-[#7289DA] transition-colors duration-150'
        >
          <title>Discord</title>
